...
<asp:Content ID="viewUpTourContent" ContentPlaceHolderID="content" Runat="Server">
    <asp:Table ID="TGUpTourTable" runat="server">
        ...
        <asp:TableRow>
            ...
            <asp:TableCell> 
                 <asp:TextBox ID="categoryText" runat="server" Columns="20" Rows="1"></asp:TextBox>  
            </asp:TableCell>
           <%-- <asp:TableCell> 
        ...
        <asp:TableRow>
            <asp:TableCell ColumnSpan="2">
                <asp:Button ID="connectTR" runat="server" Text="View Tourists List" PostBackUrl="~/viewListTR.aspx" />
            </asp:TableCell>
        </asp:TableRow>
    </asp:Table>
</asp:Content>
